...
If you simply want to use this app without diving into the code, you can access a live instance of the application hosted on vercel. The link is provided [here](https://todo-react-app-rosy.vercel.app/).
